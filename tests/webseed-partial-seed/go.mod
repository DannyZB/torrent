...
>>>>>>> upstream/master:tests/webseed-partial-seed/go.mod

go 1.22.3

require (
	github.com/dannyzb/torrent v1.56.1
...
require (
	...
	github.com/dannyzb/dht/v2 v2.19.2-0.20221121215055-066ad8494444 // indirect
